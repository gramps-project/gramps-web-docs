...
Assumiremos que o Docker e o Docker Compose já estão instalados em seu sistema. Você pode usar Windows, Mac OS ou Linux como sistema host. As arquiteturas suportadas incluem não apenas x86-64 (sistemas de desktop), mas também sistemas ARM, como um Raspberry Pi, que pode servir como um servidor web de baixo custo, mas poderoso (o suficiente).
...
- Usar hospedagem Docker que inclui SSL/TLS automaticamente
- Usar um Proxy Reverso Nginx com um certificado Let's Encrypt
