...
![Título da imagem](screenshots/sync.png){ align=left width="300"}
...
Usando o [Gramps Web Sync Add-on](../administration/sync.md) para Gramps Desktop, os dados podem ser sincronizados de forma bidirecional entre o Gramps Web e o Gramps Desktop! Vá em frente e edite seus dados com o Gramps Web ou o aplicativo Gramps Desktop que você conhece e ama – eles funcionam juntos perfeitamente!

<div style="clear:both;"></div>

---

![Título da imagem](screenshots/fan.png){ align=right width="400"}

## Gráficos interativos de árvore genealógica
...
![Título da imagem](screenshots/tree-edit.png){ align=left width="400"}

## Construa sua árvore diretamente no gráfico

Mude a visualização da árvore para o modo de edição e cresça sua árvore genealógica sem sair do gráfico. Cada cartão de pessoa recebe um botão **+** para adicionar um pai, mãe, filho ou cônjuge – vinculando alguém já em seu banco de dados ou criando uma nova pessoa no local. Cada alteração é salva imediatamente.

Veja [Editando a Árvore Genealógica](../user-guide/tree-edit.md).

<div style="clear:both;"></div>

---

![Título da imagem](screenshots/timeline.png){ align=right width="400"}

## Linha do tempo cronológica

Veja cada evento em sua árvore genealógica disposto em uma linha do tempo horizontal e ampliável. Role e amplie pelos séculos, depois filtre para uma única pessoa – ou para todos os seus ancestrais ou descendentes – ou para tudo que aconteceu em um único lugar.
...
![Título da imagem](screenshots/map.png){ align=left width="400"}

## Mapa poderoso

Exiba todos os lugares em sua árvore em um mapa interativo e pesquisável. Pesquise novos lugares diretamente no OpenStreetMap ao criar um lugar, plote as pessoas em seu banco de dados geograficamente e trace a vida de uma única pessoa conectando seus eventos com linhas no mapa.

<div style="clear:both;"></div>

---

![Título da imagem](screenshots/ohm.png){ align=right width="400"}
...
![Título da imagem](screenshots/search.png){ align=left width="400"}
...
Se o seu servidor tiver isso habilitado, a **busca semântica** responde a consultas em linguagem natural como "fazendeiro na Baviera no século 19" por significado em vez de por palavras exatas. Para consultas precisas, as visualizações de lista de objetos oferecem um modo de filtro avançado baseado na [Linguagem de Consulta Gramps](../user-guide/gql.md), juntamente com filtros rápidos por texto, tag e privacidade.
...
![Título da imagem](screenshots/chat.png){ align=right width="400"}
...
Dados brutos de SNP do cromossomo Y podem ser usados para determinar o [haplogrupo Y-DNA](../user-guide/y-dna.md) mais provável de uma pessoa e exibir seus ancestrais patrilineares na árvore do cromossomo Y humano, com estimativas de tempo. A análise é realizada inteiramente em seu próprio servidor – nenhum dado é enviado a terceiros.

<div style="clear:both;"></div>

---

![Título da imagem](screenshots/tag.png){ align=right width="400"}
...
![Título da imagem](screenshots/revisions.png){ align=left width="400"}

## Histórico de revisões completo – com desfazer

Cada edição em sua árvore genealógica é registrada. Navegue pelo histórico completo agrupado por transação, aprofunde-se em qualquer alteração individual para ver exatamente quais campos foram adicionados, removidos ou modificados, e desfaça uma transação se descobrir que foi um erro. A página de cada objeto também possui sua própria aba de revisão mostrando quem a alterou e quando.
...
![Título da imagem](screenshots/list.png){ align=right width="400"}
...
Os usuários podem fazer login com uma senha ou por meio de um provedor de identidade externo usando [OpenID Connect](../install_setup/oidc.md) – Google e Microsoft de forma padrão, além de provedores personalizados como Keycloak, Authentik e Authelia.

<div style="clear:both;"></div>

---

![Título da imagem](screenshots/blog.png){ align=left width="400"}

## Blog de genealogia incluído

Resuma sua pesquisa na forma de histórias de blog com imagens e compartilhe-as com seus parentes. Um editor dedicado torna a escrita de um novo post simples. Todos os dados são armazenados no banco de dados do Gramps.

<div style="clear:both;"></div>

---

![Título da imagem](screenshots/tasks.png){ align=right width="400"}

## Aplicativo de gerenciamento de tarefas integrado
...
![Título da imagem](screenshots/report.png){ align=left width="400"}
...
![Título da imagem](screenshots/export.png){ align=right width="300"}

## Sem bloqueio – importação e exportação de dados

Além de poder importar dados em vários formatos, incluindo Gramps XML e GEDCOM, o Gramps Web facilita para os usuários baixarem todos os seus dados (dados da árvore genealógica, arquivos de mídia, contas de usuário) a qualquer momento, para fins de backup ou para mudar para um servidor diferente. Seus dados são apenas seus!

As importações podem ser visualizadas como uma execução de teste antes de qualquer coisa ser escrita, e um backup completo pode ser restaurado de volta na árvore.

<div style="clear:both;"></div>

---

![Título da imagem](screenshots/mobile.png){ align=left width="400"}

## Funciona em qualquer dispositivo

Acesse o Gramps Web de qualquer dispositivo com acesso à internet. Você pode fazer upload de fotos, criar ou editar registros, mostrar sua árvore genealógica para outras pessoas ou procurar aqueles nomes de membros da família que você não consegue lembrar em sua próxima reunião de família!
...
![Título da imagem](screenshots/lang.png){ align=right width="300"}
...
- **Edição em massa** – selecione múltiplos objetos nas visualizações de lista para excluí-los de uma vez ou mesclar objetos duplicados
...
- **Calendários** – insira datas no calendário gregoriano, juliano, hebraico, republicano francês, persa, islâmico ou sueco
