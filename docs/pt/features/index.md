...
Mude a visualização da árvore para o modo de edição e cresça sua árvore genealógica sem sair do gráfico. Cada cartão de pessoa recebe um botão **+** para adicionar um pai, mãe, filho ou cônjuge – seja vinculando alguém já em seu banco de dados ou criando uma nova pessoa na hora. Cada alteração é salva imediatamente.
...
Resuma sua pesquisa na forma de histórias de blog com fotos e compartilhe-as com seus parentes. Um editor dedicado torna a escrita de um novo post simples. Todos os dados são armazenados no banco de dados do Gramps.
