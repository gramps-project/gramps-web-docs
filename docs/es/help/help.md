...
Si encuentras problemas o necesitas ayuda con Gramps Web, por favor elige una de las siguientes opciones.
...
Consulta a continuación algunas orientaciones sobre por dónde empezar.
...
- Solución de problemas de una implementación de Gramps Web
- Ideas sobre mejoras para Gramps Web
- ...

## Reportar problemas

Si encuentras un problema que crees que es un error en Gramps Web, por favor, repórtalo a través de Github.
...
- Información de versión. Para obtenerla, ve a la pestaña "Información del sistema" en la página de Configuración en Gramps Web y copia/pega los valores en el cuadro, que debería verse algo así:
...
Para ideas generales y discusión sobre futuras mejoras, siéntete libre de abrir una discusión en el [foro](https://gramps.discourse.group/c/gramps-web/). También puedes querer revisar las páginas de problemas (ver enlaces arriba) para ver si una característica particular ya está planeada o en desarrollo.

Para mejoras específicas con un alcance limitado, siéntete libre de abrir directamente un problema con una solicitud de función en el repositorio de Github de frontend o backend correspondiente.
