...
- **Medios** – navegar por todos los archivos de medios (fotos, documentos, etc.)
- **Asistente** – asistente de chat de IA (si está habilitado por el administrador)
- **Historial** – objetos modificados recientemente
...
- **Agregar** (icono de más, visible para colaboradores y superiores) – abre un menú para crear un nuevo objeto: Persona, Familia, Evento, Lugar, Fuente, Cita, Repositorio, Nota, Objeto de Medios o Tarea
...
- **Tarjeta de persona en casa** – muestra el nombre, la foto (si está disponible) y los datos clave de tu persona en casa elegida, con un enlace a su perfil completo y navegación rápida al árbol familiar. Haz clic en el botón **Establecer Persona en Casa** en la tarjeta para buscar y seleccionar a otra persona.
...
Mientras el árbol esté vacío, el panel de control oculta los paneles que no tendrían nada que mostrar y en su lugar muestra una tarjeta de **Comenzar** para usuarios con permisos de edición: primero ofrece crear una persona o importar un archivo de árbol familiar, y una vez que existan personas, conectarlas creando una familia. La tarjeta desaparece tan pronto como el árbol contiene una familia.
...
- **Escritorio (Firefox, Safari)** – la instalación no es compatible; usa una pestaña o ventana normal del navegador.
...
!!! note
    Gramps Web aún necesita llegar a tu servidor para mostrar tus datos, por lo que una aplicación instalada no te permite navegar por tu árbol familiar sin conexión.
