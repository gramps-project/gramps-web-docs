...
!!! uyarı
    Bu hala yeni ve gelişen bir özellik olduğundan, bazı soru türleri iyi çalışırken diğerleri çalışmayabilir. Ayrıca, herhangi bir AI asistanında olduğu gibi, yanlış bilgi verebilir, bu yüzden her zaman iki kez kontrol ettiğinizden emin olun.
...
2. Gramps Web, sorunun yanıtını içerebilecek en olası (örneğin, on) Gramps nesnesini tanımlar. Bunun için "anlamsal arama" adı verilen bir teknik kullanır. Örneğin, "John Doe'nun çocuklarının isimleri nedir?" diye sorarsanız, John Doe'nun baba olduğu bir aile varsa, bu muhtemelen en üst sonuçlar arasında yer alır.
...
Her yanıt, sınırlı sayıda üst düzey anlamsal arama sonuçlarına dayandığı için, istatistikler hakkında ("veritabanımda kaç kişi var ...") soruları da yanıtlayamaz.
...
!!! ipucu
    Lütfen toplulukla işe yarayan ve yaramayan şeyler hakkında deneyiminizi paylaşın.
