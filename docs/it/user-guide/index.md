...
- **Blog** – storie di genealogia scritte come post del blog
- **Albero genealogico** – grafici interattivi dell'albero
- **Cronologia** – visualizzazione cronologica degli eventi nell'albero (richiede una versione sufficientemente recente dell'API di Gramps Web)
- **Mappa** – visualizzazione geografica dei luoghi nell'albero
- **DNA** – strumenti di analisi delle corrispondenze del DNA
- **Elenco** – esplora tutti gli oggetti di ciascun tipo: Persone, Famiglie, Eventi, Luoghi, Fonti, Citazioni, Repositories, Note
...
- **Aggiungi** (icona del più, visibile ai collaboratori e superiori) – apre un menu per creare un nuovo oggetto: Persona, Famiglia, Evento, Luogo, Fonte, Citazione, Repository, Nota, Oggetto multimediale o Compito
- **Cerca** (lente di ingrandimento) – apre la pagina di ricerca
- **Icona utente** – apre il menu delle impostazioni: Impostazioni utente, Amministrazione (solo per proprietari), Gestisci utenti (solo per proprietari), Informazioni di sistema
...
- **Scheda persona principale** – mostra il nome, la foto (se disponibile) e i fatti principali della persona principale scelta, con un link al loro profilo completo e navigazione rapida all'albero genealogico. Clicca sul pulsante **Imposta persona principale** nella scheda per cercare e selezionare un'altra persona.
...
Quando l'albero è ancora vuoto, la dashboard nasconde i pannelli che non avrebbero nulla da mostrare e invece visualizza una scheda **Inizia** per gli utenti con permessi di modifica: offre prima di creare una persona o importare un file di albero genealogico, e una volta che esistono persone, di collegarle creando una famiglia. La scheda scompare non appena l'albero contiene una famiglia.
...
!!! tip
    Se l'albero è vuoto e hai permessi di modifica, la dashboard mostra un prompt "Inizia" con pulsanti per aggiungere la tua prima persona o importare un file di albero genealogico.

## Installare Gramps Web come app

Gramps Web è un'app web progressiva (PWA), il che significa che il tuo browser può installarla accanto alle altre applicazioni invece di tenerla in una scheda del browser. Ottiene quindi la propria icona e si apre in una propria finestra, senza la barra degli indirizzi e le barre degli strumenti del browser.

Come lo installi dipende dal tuo browser:
