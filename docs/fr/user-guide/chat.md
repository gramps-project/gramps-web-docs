...
!!! info
    Le chat IA nécessite la version 2.5.0 ou supérieure de l'API Web Gramps et la version 24.10.0 ou supérieure de Gramps Web.



La vue de chat dans Gramps Web (si disponible dans votre installation) donne accès à un assistant IA qui peut répondre aux questions sur votre arbre généalogique.

!!! warning
    Étant donné qu'il s'agit encore d'une fonctionnalité nouvelle et en évolution, certains types de questions fonctionnent bien tandis que d'autres ne fonctionnent pas. De plus, comme avec tout assistant IA, il peut donner des réponses factuellement incorrectes, donc assurez-vous de toujours vérifier.
...
Étant donné que chaque réponse est basée sur un nombre limité des meilleurs résultats de recherche sémantique, il ne peut également pas répondre à des questions sur des statistiques ("combien de personnes dans ma base de données ...").
...
!!! tip
    Veuillez partager votre expérience concernant les choses qui fonctionnent et celles qui ne fonctionnent pas avec la communauté.
