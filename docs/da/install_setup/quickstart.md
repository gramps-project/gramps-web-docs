...
!!! info
    Da denne enkle opsætning ikke tillader at køre lange opgaver i en separat proces, kan import af en stor Gramps XML-fil mislykkes på grund af en timeout i første gangs assistenten.
...
Bemærk, at dette ikke vil bevare de ændringer, du foretager i databasen, når du genstarter containeren. For at opsætte Gramps Web korrekt, fortsæt med at læse om [Deployment](deployment.md).
