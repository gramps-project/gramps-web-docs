...
Vi antager, at Docker og Docker Compose allerede er installeret på dit system. Du kan bruge Windows, Mac OS eller Linux som værtsystem. De understøttede arkitekturer inkluderer ikke kun x86-64 (desktop-systemer), men også ARM-systemer såsom en Raspberry Pi, som kan fungere som en lavpris, men kraftfuld (nok) webserver.
...
Dette vil generere seks navngivne volumener for at sikre, at alle relevante data vil blive bevaret, når containeren genstartes.

!!! warning
    Ovenstående vil gøre API'en tilgængelig på port 80 på værtsmaskinen **uden SSL/TLS-beskyttelse**. Du kan bruge dette til lokal test, men udsæt ikke dette direkte for internettet, det er helt usikkert!

## Trin 2: Sikker adgang med SSL/TLS
...
Se [Docker med Let's Encrypt](lets_encrypt.md) for hvordan du opsætter det første.
...
Ved første kørsel vil appen vise en første-kørsel guide, der vil give dig mulighed for at
