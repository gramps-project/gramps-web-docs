...
- **Konto Kilde** — enten "Adgangskode" (lokal konto) eller navnet på en ekstern identitetsudbyder (f.eks. ved brug af OIDC)
...
Klik på redigerings (blyant) ikonet på en hvilken som helst række for at åbne redigeringsdialogen. Du kan ændre brugerens:
...
## Eksportér og importér brugerkonti
...
- **Importér brugerkonti** (gruppe-tilføj ikon) — uploader en tidligere eksporteret JSON-fil for at oprette brugerkonti i bulk. Alle importerede brugere skal indstille en ny adgangskode via "Glemt adgangskode" linket, da adgangskoder ikke kan overføres.

## Registreringslink (multi-træ opsætning kun)
...
!!! note
    I en enkelt-træ opsætning er der et generisk "Registrer" link på login-siden; det per-træ registreringslink er kun nødvendigt i multi-træ installationer.
