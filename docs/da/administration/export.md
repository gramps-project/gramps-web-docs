...
Når du klikker på "eksporter", genereres filen, og downloadingen starter, når den er klar.
...
Denne Gramps XML-fil kan senere bruges til at gendanne træet til denne nøjagtige tilstand via [Gendan fra sikkerhedskopi](settings.md#restore-from-backup).
...
For at sikkerhedskopiere dine mediefiler kan du oprette og downloade en ZIP-arkiv af alle mediefiler på eksport-siden.

Bemærk, at dette, især for store træer, kan være en kostbar operation for serveren og kun bør gøres, hvis det er absolut nødvendigt.
...
3. Gå til Indstillinger > Administration > Administrer brugere og klik på knappen "Eksporter brugeroplysninger". Det vil downloade en JSON-fil.
...
Bemærk, at mens dine brugerkonti vil blive migreret, skal alle dine brugere indstille nye adgangskoder ved at bruge linket "glemt adgangskode", da adgangskoder gemmes i krypteret form og ikke kan eksporteres.
