...
```yaml
      ...
      # Учетные данные должны совпадать с теми, которые используются для
...
В случае возникновения проблем, пожалуйста, следите за выводом логов Gramps Web и сервера PostgreSQL. В случае с Docker это достигается с помощью
