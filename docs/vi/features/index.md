...
![Hình ảnh tiêu đề](screenshots/fan.png){ align=right width="400"}
...
![Hình ảnh tiêu đề](screenshots/tree-edit.png){ align=left width="400"}
...
![Hình ảnh tiêu đề](screenshots/timeline.png){ align=right width="400"}

## Dòng thời gian theo trình tự

Xem mọi sự kiện trong cây gia đình của bạn được trình bày trên một dòng thời gian ngang, có thể phóng to. Cuộn và phóng to qua các thế kỷ, sau đó lọc xuống một người duy nhất – hoặc tất cả tổ tiên hoặc con cháu của họ – hoặc mọi thứ đã xảy ra ở một địa điểm.

Xem [Dòng thời gian](../user-guide/timeline.md).

<div style="clear:both;"></div>

---

![Hình ảnh tiêu đề](screenshots/map.png){ align=left width="400"}
...
![Hình ảnh tiêu đề](screenshots/ohm.png){ align=right width="400"}
...
![Hình ảnh tiêu đề](screenshots/search.png){ align=left width="400"}
...
![Hình ảnh tiêu đề](screenshots/chat.png){ align=right width="400"}
...
![Hình ảnh tiêu đề](screenshots/tag.png){ align=right width="400"}
...
![Hình ảnh tiêu đề](screenshots/blog.png){ align=left width="400"}

## Blog gia phả đi kèm

Tóm tắt nghiên cứu của bạn dưới dạng các câu chuyện blog với hình ảnh, và chia sẻ chúng với người thân của bạn. Một trình soạn thảo chuyên dụng giúp việc viết một bài đăng mới trở nên đơn giản. Tất cả dữ liệu được lưu trữ trong cơ sở dữ liệu Gramps.
...
![Hình ảnh tiêu đề](screenshots/report.png){ align=left width="400"}
...
![Hình ảnh tiêu đề](screenshots/export.png){ align=right width="300"}

## Không bị khóa – nhập và xuất dữ liệu
...
![Hình ảnh tiêu đề](screenshots/mobile.png){ align=left width="400"}
...
Để đăng nhập vào Demo, sử dụng bất kỳ một trong các thông tin đăng nhập ***USER / PASS*** sau đây. Mỗi thông tin đại diện cho một loại người dùng mà người dùng Gramps Web có thể được gán.
...
[Đi đến Đăng nhập Demo](https://demo.grampsweb.org/){ .md-button .md-button--primary target="_blank"}


### Cảm ơn

Demo được hỗ trợ bởi DigitalOcean.
